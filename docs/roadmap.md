...
- [x] **タスク5.3.1.2**: シークレット登録

##### ストーリー5.3.2: Supabaseプロジェクト設定
- [x] **タスク5.3.2.1**: リモートプロジェクト作成
- [x] **タスク5.3.2.2**: 本番環境セキュリティ設定

##### ストーリー5.3.3: データマイグレーション
- [x] **タスク5.3.3.1**: マイグレーションスクリプト確認・調整
- [x] **タスク5.3.3.2**: スキーマ移行実行
- [x] **タスク5.3.3.3**: インデックスとRLSポリシー移行
- [x] **タスク5.3.3.4**: 移行後のスキーマ検証

##### ストーリー5.3.4: 本番配置
- [x] **タスク5.3.4.1**: Supabaseプロジェクト設定確認
- [x] **タスク5.3.4.2**: フロントエンドのビルド確認
- [x] **タスク5.3.4.3**: Vercelへのデプロイ実行
- [ ] **タスク5.3.4.4**: デプロイ後テスト
